...
public abstract class Teste {
    ...
    private static BDVeiculos bd = new BDVeiculos(5);
    ...
    private static void cadastrarVp() throws VeicExistException, VelocException{
        ...
        if (contadorP >= bd.getPasseio().length) {
            System.out.println("\nNao ha espaco para mais Veiculos de Passeio.");
            return;
        }
        ...
        bd.getPasseio()[contadorP] = passeio;
        contadorP++;
    ...
    private static void cadastrarVc() throws VeicExistException, VelocException{
        ...
        if (contadorC >= bd.getCarga().length) {
    ...
    private static boolean placaExiste(String placa) {
        ...
        for (int i = 0; i < contadorP; i++) {
            if (bd.getPasseio()[i].getPlaca().equals(placa)){
                return true;
            } 
        }
        ...
        for (int i = 0; i < contadorC; i++) {
            if (bd.getCarga()[i].getPlaca().equals(placa)){
                return true;
            } 
        }
        return false;
    ...
    private static void mostrarTodosVp() {
        if (contadorP == 0) {
            ...
            for (int i = 0; i < contadorP; i++) {
                System.out.println(bd.getPasseio()[i]);
                System.out.println("\n\n---------------------------------");
            }
        }
    }
    ...
    private static void mostrarTodosVc() {
        if (contadorC == 0) {
            ...
            for (int i = 0; i < contadorC; i++) {
                System.out.println(bd.getCarga()[i]);
                System.out.println("\n\n---------------------------------");
            }
        }
    }
